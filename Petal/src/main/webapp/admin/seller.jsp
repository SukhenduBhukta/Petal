						...
						<tbody>
							...
							%>
								...
								<tr>
									...
									<td><%=us.getUserid()%></td>
									<td><a href="allProduct.jsp?id=<%=us.getUserid() %>" style="color:green;" ><%=us.getFname() + " " + us.getLname()%></a></td>
									<td><%=us.getPhone()%></td>
									<td><%=us.getEmail()%></td>
									<td><a download="../Documents/<%=us.getPhotoName()%>"
										href="../Documents/<%=us.getPhotoName()%>" target="_blank">Check
											Document</a></td>
									<td>
										<a href="../deleteseller?id=<%=us.getUserid()%>"><button
												type="submit" class="reject">Reject</button></a></td>
