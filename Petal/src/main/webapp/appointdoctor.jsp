				...
				<ul class="form-section">
					<div class="top-form-try">
						<li class="form-line-col-1">
							<div>
								<img alt="Image" class="form-image" src="./all/Img/logo.png" />
							</div>
						</li>
						...
						<li class="form-col-2">
							<div class="form-input-wide">
								<div class="form-html">
									<div>
										<div>
											<strong>PET CARE Hospital</strong>
										</div>
					...
					<li class="form-input-wide-2">
						<div class="form-header-group">
							<div class="header-text">
								...
								<p>Fill the form below and we will get back soon to you for
					...
					<div class="name-input">
						<div class="labinput">
							<div class="text">
								<label for=""><span style="color: red;">*</span>Owner
									Name : -</label>
							</div>
							<input type="text" required="required"
								value="${userobj.fname } ${userobj.lname }" name="ownerName" />
						</div>
						<div class="labinput">
							<div class="text">
								<label for=""><span style="color: red;">*</span>Pet Name
									: -</label>
							</div>
					...
					<div class="phone-gender">
						<div class="inputbox">
							<div class="labinput1">
								<div class="text">
									<label for=""><span style="color: red;">*</span>Gender
										: -</label>
								</div>
						...
						<div class="inputbox">
							<div class="labinput">
								<div class="text">
									<label for=""><span style="color: red;">*</span>Mobile
										: -</label>
								</div>
								<input type="number" required="required"
									value="${userobj.phone }" name="mobile" />
							</div>
						</div>
					...
					<div class="address-pet">
						<div class="labinput">
							<div class="text">
								<label for=""><span style="color: red;">*</span>Address
									: -</label>
							</div>
							<input type="text" required="required" value="${userobj.house }"
								name="address" />
						</div>
						<div class="labinput">
							<div class="text">
					...
					<div class="address-pet-dist">
						<div class="labinput">
							<div class="text">
								<label for=""><span style="color: red;">*</span>City : -</label>
							</div>
							<input type="text" required="required" value="${userobj.city }"
								name="city" />
						</div>
						<div class="labinput">
							<div class="text">
								<label for=""><span style="color: red;">*</span>State :
									-</label>
							</div>
							<input type="text" required="required" value="${userobj.state }"
								name="state" />
						</div>
						<div class="labinput">
							<div class="text">
								<label for=""><span style="color: red;">*</span>Pin Code
									: -</label>
							</div>
							<input type="number" required="required" value="${userobj.pin }"
								name="pinCode" />
						</div>
					</div>
					<div class="email-add">
						<div class="labinput">
							<div class="text">
								<label for=""><span style="color: red;">*</span>Email :
									-</label>
							</div>
						...
						<div class="labinput2">
							<div class="text">
								<label for=""><span style="color: red;">*</span>Age: -</label>
							</div>
					...
					<div class="email-add">
						<div class="labinput">
							<div class="text">
								<label for=""><span style="color: red;">*</span>Date: -</label>
							</div>
						...
						<div class="labinput">
							<div class="text">
								<label for=""></span>Select Doctor: -</label>
							</div>
							<select name="option1">
								<%
								int did = Integer.parseInt(request.getParameter("did"));
								DoctorDAOImpl dao = new DoctorDAOImpl(DBconnect.getCon());
								Doctor us = dao.getDoctorSinglebyId(did);
								%>
								<option value="<%=us.getDid()%>">Dr.
									<%=us.getDfname() + " " + us.getLfname()%></option>
								<%
					...
					<div class="appontment-section"></div>
