...
<%@include file="navbar.jsp"%>
  ...
  <form id="editForm" action="../editprofile2" method="post" enctype="multipart/form-data">
  <input name="uid" value="<%=u.getDid() %>" type="hidden">
    <label for="fullName">First Name</label>
    <input type="text" id="fullName" name="fname" value="<%=u.getDfname() %>" required>
    <label for="fullName">Last Name</label>
    <input type="text" id="fullName" name="lname" value="<%=u.getLfname() %>" required>

    <label for="email">Email</label>
    <input type="email" id="email" name="email" value="<%=u.getEmial() %>" required>

    <label for="mobileNumber">Mobile Number</label>
    <input type="number" id="mobileNumber" name="mobileNumber" value="<%=u.getPhone() %>" required>
    
    <label for="email">Designation</label>
    <input type="text" id="email" name="desig" value="<%=u.getDesignation() %>" required>
