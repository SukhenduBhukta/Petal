				...
				<div class="recentorders">
					...
					<table>
						...
						<tbody>
							...
							<tr>
								<td><%=g.getId()%></td>
								<td><img src="../Documents/<%=g.getPhoto()%>"
								...
								<td><%=g.getStatus()%></td>
								<td><a href="editproduct.jsp?id=<%=g.getId()%>"><button
											type="submit" class="add">Edit</button></a> <a
									href="../DeleteProduct?id=<%=g.getId()%>"><button
											type="submit" class="reject">Delete</button></a></td>
							</tr>
							<%
							}
							%>
